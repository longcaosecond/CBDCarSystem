...
<p class="qianmian">包租婆用户名：<span class = "info">${want.rent.user.userAccount}</span></p>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" id = "nei32">
<p class="qianmian">包租婆职业：<span class = "info">${want.rent.user.userWork}</span></p>
</div>
</div>
<div class = "row" id = "row15">
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" id = "nei31">
<p class="qianmian">包租婆电话：<span class = "info">${want.rent.user.userPhone}</span></p>
</div>
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" id = "nei32">
<p class="qianmian">包租婆信誉度：<span class = "info">${want.rent.user.userCredit}</span></p>
</div>
</div>
<div class = "row" id = "row16">
<p id="message">回馈信息：<span class = "info">车位主人已同意和您签订合约</span></p>
</div>
<div class = "row" id = "row17">
<input type = "button" class="btn btn-success" id = "btn" value = "签约"><input type = "button" class="btn btn-danger" id = "btn1" value = "放弃"><input type = "button" class="btn btn-info" id = "btn2" value = "返回">
</div>
</div>
</div>
</div>
...
<script src="<c:url value='/js/informationRightEvent.js'/>"></script>
</html>