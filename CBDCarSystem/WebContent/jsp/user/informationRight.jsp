...
<title>信息中心</title>
 ...
 <link rel="stylesheet" href="<c:url value='/css/global.css'/>" />
     <link rel="stylesheet" href="<c:url value='/css/userInfo.css'/>" />
      <link rel="stylesheet" href="<c:url value='/css/informationRight.css'/>" />
</head>
<body>
...
<div class = "row" id = "row6">
 <p class = "zuo1"><a href="<c:url value='/jsp/user/information'/>"><span id = "hang3">信息中心</span></a></p>
</div>
</div>
...
<script src="<c:url value='/js/informationRight.js'/>"></script>
</html>